...
mod tests {
    ...
    macro_rules! board_after_move_is {
        ($mv:expr, $initial:expr, $result:expr) => {{
            ...
            assert_eq!(
                b.make_move(&Move::from_algebra($mv).expect("[board_after_move_is] bad move"))
                    .unwrap(),
    ...
    #[test]
    fn white_en_passant() {
        let b = legal_moves_are!("8/8/8/pP6/8/8/8/8 w - a6 0 1", "b5-b6", "b5xa6e.p.");
    ...
    #[test]
    fn white_castling() {
        legal_moves_include!("8/8/8/8/8/8/8/R3K2R w KQ - 0 1", "O-O", "O-O-O");
        board_after_move_is!(
            "O-O",
    ...
    #[test]
    fn black_castling() {
        legal_moves_include!("r3k2r/8/8/8/8/8/8/8 b kq - 0 1", "O-O", "O-O-O");
        board_after_move_is!(
            "O-O",
